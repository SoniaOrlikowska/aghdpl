...
\begin{document}
	...
	choose the best solver. The most important factor to differentiate different types of maze generators is a cross versus dead-end ratio. 
	The fastest solver for each, assessed maze type is Dijkstra. Besides McClendon's complexity measure, Shannon's entropy may be considered  
	as an accurate complexity measure.\\
	\\
